...
import sty from "./PlasmicTextInput.module.css"; // plasmic-import: a3kKYHRv45O8/css
  ...
  return (() => {
    const child$Props = {
      ...
      className: classNames(
        ...
        sty.ariaInput,
        {
          [sty.ariaInputalignCentered]: hasVariant(
            $state,
            "alignCentered",
            "alignCentered"
          ),
          ...
          [sty.ariaInputroundedFull]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.ariaInputtype_dark]: hasVariant($state, "type", "dark"),
