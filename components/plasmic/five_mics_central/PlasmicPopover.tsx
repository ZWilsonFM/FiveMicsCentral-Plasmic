...
import OverlayArrow from "../../OverlayArrow"; // plasmic-import: hjXoJ0mY0U1i/component
...
import sty from "./PlasmicPopover.module.css"; // plasmic-import: HHj6wshD27fe/css
  ...
  return (
    <BaseDialogTrigger
      ...
      dialog={
        ...
        >
          ...
          >
            {renderPlasmicSlot({
              defaultContents: (
                <div className={classNames(projectcss.all, sty.freeBox__pr4AR)}>
                  <div
                    className={classNames(
                      projectcss.all,
      ...
      trigger={renderPlasmicSlot({
        defaultContents: (
          <Button
            className={classNames("__wab_instance", sty.button___95M8F)}
            label={"Open Popover"}
          />
        ),
