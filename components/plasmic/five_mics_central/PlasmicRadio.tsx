...
import sty from "./PlasmicRadio.module.css"; // plasmic-import: gmdXVGeKyqh2/css
...
function PlasmicRadio__RenderFunc(props: {
  ...
  return (
    <BaseRadio
      ...
      value={args.value}
    >
      <div className={classNames(projectcss.all, sty.freeBox__r7Ppv)}>
        <div className={classNames(projectcss.all, sty.freeBox___40Ldc)} />
      </div>
      {renderPlasmicSlot({
