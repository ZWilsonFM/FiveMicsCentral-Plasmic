...
import MenuPopover from "../../MenuPopover"; // plasmic-import: nP354ZE5VWSk/component
import MenuItem from "../../MenuItem"; // plasmic-import: 3vE2gi5oOFPv/component
import MenuSection from "../../MenuSection"; // plasmic-import: Y-aThhdamgIt/component
...
import sty from "./PlasmicCombobox.module.css"; // plasmic-import: xN73zdZC0r4i/css
        ...
        menuItems={renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              ...
              <MenuSection
                className={classNames("__wab_instance", sty.menuSection__pLlgu)}
                header={
                  <div
                    className={classNames(
                      projectcss.all,
