...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 6jE3Dsyufpzc/css
    ...
    <BaseButton
      ...
      className={classNames(
        ...
        sty.root,
        {
          ...
          [sty.rootcolor_errorDestructive_type_noFill]:
            hasVariant($state, "color", "errorDestructive") &&
            hasVariant($state, "type", "noFill"),
          ...
          [sty.rooticonStart_color_errorDestructive_type_noFill]:
            hasVariant($state, "color", "errorDestructive") &&
            hasVariant($state, "type", "noFill") &&
          ...
          [sty.roottype_bordered_color_warning]:
            hasVariant($state, "color", "warning") &&
            hasVariant($state, "type", "bordered"),
          [sty.roottype_noFill]: hasVariant($state, "type", "noFill"),
    ...
    >
      ...
      <div
        ...
        className={classNames(projectcss.all, sty.interactionEffect, {
          ...
          [sty.interactionEffectcolor_errorDestructive_type_noFill]:
            hasVariant($state, "color", "errorDestructive") &&
            hasVariant($state, "type", "noFill"),
          ...
          [sty.interactionEffecticonStart_color_errorDestructive_type_noFill]:
            hasVariant($state, "iconStart", "iconStart") &&
            hasVariant($state, "color", "errorDestructive") &&
            hasVariant($state, "type", "noFill"),
          ...
          [sty.interactionEffecttype_noFill]: hasVariant(
            $state,
            "type",
            "noFill"
          ),
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__mneVf, {
          [sty.freeBoxcolor_errorDestructive_type_noFill__mneVfCtzqyQQwB]:
            hasVariant($state, "color", "errorDestructive") &&
            hasVariant($state, "type", "noFill"),
          [sty.freeBoxcolor_neutral__mneVfhzdJ]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__mneVf1PLrXkNoo]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__mneVfQfzNa]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxiconStart_color_errorDestructive_type_noFill__mneVf8TQvrCtzqyQQwB]:
            hasVariant($state, "iconStart", "iconStart") &&
            hasVariant($state, "color", "errorDestructive") &&
            hasVariant($state, "type", "noFill"),
          [sty.freeBoxroundedFull__mneVfCq9Qz]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__mneVfyUhmw]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__mneVfhoyXm]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__mneVfKa5T]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__mneVf8Xkmd]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__mneVfXkNoo]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__jeMm0, {
            [sty.freeBoxcolor_neutral__jeMm0HzdJ]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__jeMm0HzdJMS3Kw]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconOnly__jeMm0AOxU]: hasVariant(
              $state,
              "iconOnly",
              "iconOnly"
            ),
            [sty.freeBoxiconStart__jeMm08TQvr]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__jeMm0YUhmw]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__jeMm0Ka5T]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__jeMm08Xkmd]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__jeMm0XkNoo]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__sOFdB)}
                role={"img"}
              />
            ),
            ...
            className: classNames(sty.slotTargetStart, {
              ...
              [sty.slotTargetStartcolor_errorDestructive_type_bordered]:
                hasVariant($state, "color", "errorDestructive") &&
                hasVariant($state, "type", "bordered"),
              [sty.slotTargetStartcolor_errorDestructive_type_noFill]:
                hasVariant($state, "color", "errorDestructive") &&
                hasVariant($state, "type", "noFill"),
              ...
              [sty.slotTargetStarticonStart_color_errorDestructive_type_noFill]:
                hasVariant($state, "iconStart", "iconStart") &&
                hasVariant($state, "color", "errorDestructive") &&
                hasVariant($state, "type", "noFill"),
        ...
        {(hasVariant($state, "iconOnly", "iconOnly") ? false : true)
          ? renderPlasmicSlot({
              ...
              className: classNames(sty.slotTargetLabel, {
                ...
                [sty.slotTargetLabelcolor_errorDestructive_type_bordered]:
                  hasVariant($state, "color", "errorDestructive") &&
                  hasVariant($state, "type", "bordered"),
                [sty.slotTargetLabelcolor_errorDestructive_type_noFill]:
                  hasVariant($state, "color", "errorDestructive") &&
                  hasVariant($state, "type", "noFill"),
                ...
                [sty.slotTargetLabeliconOnly]: hasVariant(
                  $state,
                  "iconOnly",
                  "iconOnly"
                ),
                ...
                [sty.slotTargetLabeliconStart_color_errorDestructive_type_noFill]:
                  hasVariant($state, "iconStart", "iconStart") &&
                  hasVariant($state, "color", "errorDestructive") &&
                  hasVariant($state, "type", "noFill"),
          ...
          : null}
        <div
          className={classNames(projectcss.all, sty.freeBox__uax6, {
            [sty.freeBoxiconEnd__uax6FzUtt]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__uax6YUhmw]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__uax6Ka5T]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__uax68Xkmd]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDownIcon
                className={classNames(projectcss.all, sty.svg__wuhgZ)}
                role={"img"}
              />
            ),
