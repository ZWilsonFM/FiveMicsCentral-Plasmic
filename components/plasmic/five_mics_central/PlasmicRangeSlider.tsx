...
import SliderThumb from "../../SliderThumb"; // plasmic-import: FUlidfVOYDD5/component
...
import sty from "./PlasmicRangeSlider.module.css"; // plasmic-import: _r8Wvxq_uJxr/css
...
function PlasmicRangeSlider__RenderFunc(props: {
  ...
  return (
    ...
    >
      <div className={classNames(projectcss.all, sty.freeBox__wCiIu)}>
        {$props.showLabel ? (
          <Label
      ...
      <div className={classNames(projectcss.all, sty.freeBox__oLmAb)}>
        <div
