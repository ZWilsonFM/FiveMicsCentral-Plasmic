...
import Radio from "../../Radio"; // plasmic-import: gmdXVGeKyqh2/component
...
import sty from "./PlasmicRadioGroup.module.css"; // plasmic-import: MRT3MMgI3_xn/css
...
function PlasmicRadioGroup__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      {renderPlasmicSlot({
        defaultContents: (
          <div className={classNames(projectcss.all, sty.freeBox__uzhl9)}>
            <Radio
              className={classNames("__wab_instance", sty.radio___0Al6Y)}
              label={"Option 1"}
              value={"option1"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__lbMjI)}
              label={"Option 2"}
              value={"option2"}
            />

            <Radio
              className={classNames("__wab_instance", sty.radio__fMQk)}
              label={"Option 3"}
              value={"option3"}
            />
          </div>
