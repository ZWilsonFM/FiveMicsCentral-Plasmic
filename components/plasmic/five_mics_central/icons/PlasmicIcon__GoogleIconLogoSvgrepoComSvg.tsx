...
export type GoogleIconLogoSvgrepoComSvgIconProps =
  React.ComponentProps<"svg"> & {
    title?: string;
  };

export function GoogleIconLogoSvgrepoComSvgIcon(
  props: GoogleIconLogoSvgrepoComSvgIconProps
) {
  ...
  return (
    ...
    >
      ...
      <path
        fill={"#FBBC05"}
        d={
          "M56.281 156.37c-2.756-8.123-4.351-16.827-4.351-25.82 0-8.994 1.595-17.697 4.206-25.82l-.073-1.73L15.26 71.312l-1.335.635C5.077 89.644 0 109.517 0 130.55s5.077 40.905 13.925 58.602z"
        }
      ></path>
...
export default GoogleIconLogoSvgrepoComSvgIcon;
/* prettier-ignore-end */
