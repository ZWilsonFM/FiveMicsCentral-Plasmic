...
import Label from "../../Label"; // plasmic-import: 2bi1bAEM6PKv/component
import TextInput from "../../TextInput"; // plasmic-import: bTOD0F4HyKA7/component
import TextAreaInput from "../../TextAreaInput"; // plasmic-import: UUnA__mjTZ_i/component
import Description from "../../Description"; // plasmic-import: MJHWnt3kh9p4/component
...
import sty from "./PlasmicTextField.module.css"; // plasmic-import: p6ddjhW3kEo1/css
...
function PlasmicTextField__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__l6OuO, {
          [sty.freeBoxiconEnd__l6OuOh5T6M]: hasVariant(
            $state,
            "iconEnd",
            "iconEnd"
          ),
          [sty.freeBoxiconStart__l6OuOkvTPj]: hasVariant(
            $state,
            "iconStart",
            "iconStart"
          ),
          [sty.freeBoxmultiLine__l6OuObUFq]: hasVariant(
            $state,
            "multiLine",
            "multiLine"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__hzODk, {
            [sty.freeBoxiconStart__hzODkkvTPj]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxmultiLine__hzODkbUFq]: hasVariant(
              $state,
              "multiLine",
              "multiLine"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__s20)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__b0AmW, {
            [sty.freeBoxiconEnd__b0AmWh5T6M]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxiconStart__b0AmWkvTPj]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__ucXrc)}
                role={"img"}
              />
            ),
