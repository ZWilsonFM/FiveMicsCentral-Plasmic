...
import sty from "./PlasmicButton.module.css"; // plasmic-import: EJtW9uUlw2QS/css
...
function PlasmicButton__RenderFunc(props: {
  ...
  return (
    ...
    >
      ...
      <div
        className={classNames(projectcss.all, sty.freeBox__xzOit, {
          [sty.freeBoxcolor_neutral__xzOitfNsMh]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_white__xzOitaKeR4]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__xzOityo6Pa]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__xzOitADpv]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__xzOitp0RgF]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__xzOitbcnyz]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__xzOitTSyT]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__xzOitELD2]: hasVariant(
            $state,
            "type",
            "bordered"
          ),
          [sty.freeBoxtype_bordered_color_success__xzOitELD2JCAp]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered")
        })}
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__lUga7, {
            [sty.freeBoxcolor_neutral__lUga7FNsMh]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxcolor_neutral_type_soft__lUga7FNsMhVLzCg]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft"),
            [sty.freeBoxiconStart__lUga7YmgTf]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__lUga7ADpv]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__lUga7Bcnyz]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__lUga7TSyT]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__lUga7ELD2]: hasVariant(
              $state,
              "type",
              "bordered"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__jwkx0)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__mpEtd, {
            [sty.freeBoxiconEnd__mpEtdQjqgb]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__mpEtdADpv]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__mpEtdbcnyz]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__mpEtdTSyT]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg___2Ay6T)}
                role={"img"}
              />
            ),
