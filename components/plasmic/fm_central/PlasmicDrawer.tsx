...
import Button3 from "../../Button3"; // plasmic-import: cHt1WXRY6qSb/component
...
import sty from "./PlasmicDrawer.module.css"; // plasmic-import: znsmbozJDcyF/css
    ...
    <BaseDialogTrigger
      ...
      dialog={
        <BaseModal
          ...
          modalOverlayClass={classNames({ [sty["pcls_UcVnc_vvdDve"]]: true })}
        ...
        >
          ...
          >
            <div className={classNames(projectcss.all, sty.freeBox___5VMmg)}>
              {renderPlasmicSlot({
                defaultContents: (
                  <h2
                    className={classNames(
              ...
              >
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__ezQcs)}
                    >
                      <div
                        className={classNames(
                          projectcss.all,
              ...
              <div className={classNames(projectcss.all, sty.freeBox__bbQ7Q)}>
                {renderPlasmicSlot({
                  defaultContents: (
                    <div
                      className={classNames(projectcss.all, sty.freeBox__zjGms)}
                    >
                      <Button3
                        color={"muted"}
                        label={"Close"}
      ...
      trigger={
        (hasVariant($state, "noTrigger", "noTrigger") ? false : true)
          ? renderPlasmicSlot({
              defaultContents: (
                <Button3
                  className={classNames("__wab_instance", sty.button3__qBrY7)}
                  label={
                    <div
                      className={classNames(
                        projectcss.all,
