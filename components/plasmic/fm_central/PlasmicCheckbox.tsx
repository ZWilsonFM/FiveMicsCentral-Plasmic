...
import sty from "./PlasmicCheckbox.module.css"; // plasmic-import: 7KtYPL8xZXmj/css

import CheckIcon from "./icons/PlasmicIcon__Check"; // plasmic-import: 8BSI_i0SuedK/icon
import MinusIcon from "./icons/PlasmicIcon__Minus"; // plasmic-import: C_EkTC8G-uKe/icon
    ...
    >
      ...
      >
        {(
          ...
          <CheckIcon
            className={classNames(projectcss.all, sty.svg__nlfXd)}
            role={"img"}
          />
        ) : null}
        {($ccVariants["indeterminate"] ? true : false) ? (
          <MinusIcon
            className={classNames(projectcss.all, sty.svg___1STyW)}
            role={"img"}
          />
        ) : null}
      </div>
